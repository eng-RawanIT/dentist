...
class BasicTablesSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        DB::table('appointments')->insert([
            ['request_id' => 1,'patient_id' => 1, 'student_id' => 1, 'date' => '2025-07-01', 'time' => '09:00:00'],
            ['request_id' => 2,'patient_id' => 2, 'student_id' => 2, 'date' => '2025-07-02', 'time' => '10:00:00'],
        ]);

        DB::table('sessions')->insert([
            ['appointment_id' => 1, 'supervisor_comments' => 'Good progress', 'evaluation_score' => 4.5, 'description' => json_encode(['en' => 'Completed step 1', 'ar' => 'أكمل الخطوة 1']), 'supervisor_id' => 1],
            ['appointment_id' => 2, 'supervisor_comments' => 'Needs more practice', 'evaluation_score' => 3.8, 'description' => json_encode(['en' => 'Completed step 2', 'ar' => 'أكمل الخطوة2']), 'supervisor_id' => 2],
        ]);
