...
class BasicTablesSeeder extends Seeder
{
    ...
    public function run(): void
    {
        DB::table('students')->insert([
            ['user_id' => 1, 'year' => 'fourth-year' , 'profile_image_url' => 'student1.jpg'],
            ['user_id' => 2, 'year' => 'fifth-year' , 'profile_image_url' => 'student2.jpg'],
        ]);
        ...
        DB::table('appointments')->insert([
            ...
            ['request_id' => 1,'patient_id' => 1, 'student_id' => 1, 'stage_id' => 3, 'date' => '2025-08-01', 'time' => '09:00:00'],
