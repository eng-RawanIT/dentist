...
class BasicTablesSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        DB::table('sessions')->insert([
            ['appointment_id' => 1, 'supervisor_comments' => 'Good progress', 'evaluation_score' => 4.5, 'description' => 'Completed step 1', 'supervisor_id' => 1],
            ['appointment_id' => 2, 'supervisor_comments' => 'Needs more practice', 'evaluation_score' => 3.8, 'description' => 'Initial attempt', 'supervisor_id' => 2],
        ]);
