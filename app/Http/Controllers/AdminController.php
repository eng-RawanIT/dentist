...
use App\Http\Requests\addPracticalRequest;
...
class AdminController extends Controller
{
    ...
    public function addPracticalSchesdule(addPracticalRequest $request)
    {
        $validated = $request->validated();

        if ($request->has('id')) {
            $schedule = PracticalSchedule::findOrFail($validated['id']);
    ...
    public function addReinternship(Request $request)
    {
        ...
        $this->notificationService->notifyUser(
            $user->id ,
            "re-internship request",
            "your re-internship request is acceptable and it is included in your practical schedule",
        );
